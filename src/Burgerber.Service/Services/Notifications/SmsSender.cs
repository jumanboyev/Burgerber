...
public class SmsSender : ISmsSender
{
    ...
    public async Task<bool> SendAsync(SmsMessange smsMessange)
    {
        var client = new HttpClient();
        client.BaseAddress = new Uri(BASE_URL);
        ...
        var content = new MultipartFormDataContent();
        content.Add(new StringContent(smsMessange.Recipent), "mobile_phone");
        content.Add(new StringContent(smsMessange.Title + " " + smsMessange.Content), "message");
        ...
        {
            await LoginAsync();
            return await SendAsync(smsMessange);
        }
